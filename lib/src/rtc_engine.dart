...
abstract class RtcEngine {
  ...
  ///
  /// Sets the channel mode of the current music file.
  /// In a stereo music file, the left and right channels can store different audio data. According to your needs, you can set the channel mode to original mode, left channel mode, right channel mode, or mixed channel mode. For example, in the KTV scenario, the left channel of the music file stores the musical accompaniment, and the right channel stores the singing voice. If you only need to listen to the accompaniment, call this method to set the channel mode of the music file to left channel mode; if you need to listen to the accompaniment and the singing voice at the same time, call this method to set the channel mode to mixed channel mode. Call this method after calling startAudioMixing and receive the audioMixingStateChanged (Playing) callback.
  ...
  ///
  /// Param [loopCount] The number of times the audio effect loops: ≥ 0: The number of playback times. For example, 1 means loop one time, which means play the audio effect two times in total.
  ///  -1: Play the music effect in an infinite loop.
  ///
  ...
  ///
  /// Param [pan] The spatial position of the audio effect. The value range is 1 to10000. -1.0: The audio effect displays to the left.
  ...
  ///
  /// Param [publish] Whether to publish the audio effect to the remote users. true: Publish the audio effect to the remote users. Both the local user and remote users can hear the audio effect.
  ...
  /// Param [soundId] The audio effect ID. The ID of each audio effect file is unique.
  ///
  /// Param [filePath] File path: Android: The file path, which needs to be accurate to the file name and suffix. Agora supports using a URI address, an absolute path, or a path that starts with /assets/.
  ...
  ///  To achieve better voice effect quality, Agora recommends setting the setAudioProfile profile parameter in asMusicHighQuality (4) orMusicHighQualityStereo (5).
  ...
  ///  After calling setAudioEffectPreset, Agora recommends not calling the following methods, because they can override setAudioEffectPreset: setVoiceBeautifierPreset
  ...
  ///  Do not set the profile parameter in setAudioProfile to SpeechStandard(1), or the method does not take effect.
  ///  This method works best with the human voice. Agora does not recommend using this method for audio containing music.
  ///  After calling setVoiceBeautifierPreset, Agora recommends not calling the following methods, because they can override setVoiceBeautifierPreset: setAudioEffectPreset
  ...
  ///  This method works best with the human voice. Agora does not recommend using this method for audio containing music.
  ///  After calling setVoiceConversionPreset, Agora recommends not calling the following methods, or the settings in setVoiceConversionPreset are overridden : setAudioEffectPreset
  ///  setAudioEffectParameters
  ...
  /// Since
  ///  v3.2.0 Call this method to set the following parameters for the local user who sends an audio stream: 3D voice effect: Sets the cycle period of the 3D voice effect.
  ...
  ///  Do not set the profile parameter in setAudioProfile to SpeechStandard (1), or the method does not take effect.
  ///  This method works best with the human voice. Agora does not recommend using this method for audio containing music.
  ///  After calling setAudioEffectParameters, Agora recommends not calling the following methods, or the settings in setAudioEffectParameters are overridden : setAudioEffectPreset
  ///  setVoiceBeautifierPreset
  ///  setLocalVoiceReverbPreset
  ///  setLocalVoiceChanger
  ///  setLocalVoicePitch
  ...
  ///  setVoiceConversionPreset
  ///
  /// Param [preset] The options for SDK preset audio effects: RoomAcoustics3DVoice, 3D voice effect: Call and set the profile parameter in setAudioProfile to MusicStandardStereo (3) or MusicHighQualityStereo(5) before setting this enumerator; otherwise, the enumerator setting does not take effect.
  ...
  ///  If you set preset to PitchCorrection , param1 sets the basic mode of the pitch correction effect: 1: (Default) Natural major scale.
  ///  2: Natural minor scale.
  ///  3: Japanese pentatonic scale.
  ///
  /// Param [param2] If you set preset to RoomAcoustics3DVoice, you need to set param2 to 0.
  ///  If you set preset to PitchCorrection, param2 sets the tonic pitch of the pitch correction effect: 1: A
  ///  2: A#
  ///  3: B
  ///  4: (Default) C
  ///  5: C#
  ...
  ///  This method works best with the human voice. Agora does not recommend using this method for audio containing music.
  ///  After calling setVoiceBeautifierParameters, Agora recommends not calling the following methods, because they can override settings in setVoiceBeautifierParameters: setAudioEffectPreset
  ///  setAudioEffectParameters
  ///  setVoiceBeautifierPreset
  ///  setLocalVoiceReverbPreset
  ///  setLocalVoiceChanger
  ...
  ///
  ///
  /// Param [param1] The gender characteristics options for the singing voice: 1: A male-sounding voice.
  ///  2: A female-sounding voice.
  ///
  ///
  /// Param [param2] The reverberation effect options for the singing voice: 1: The reverberation effect sounds like singing in a small room.
  ...
  ///
  /// Param [enabled] Whether to enable stereo panning for remote users: true: Enable stereo panning.
  ...
  ///
  /// Param [pan] The voice position of the remote user. The value ranges from -1.0 to 1.0: 0.0: (Default) The remote voice comes from the front.
  ...
  ///  This method is deprecated. This method sets the video layout and audio settings for media push. The SDK triggers the transcodingUpdated callback when you call this method to update the transcoding settings. This method takes effect only when you are a host in live interactive streaming.
  ...
  ///
  /// Param [transcodingEnabled] Whether to enable transcoding. Transcoding in a CDN live streaming converts the audio and video streams before pushing them to the CDN server. It applies to scenarios where a channel has multiple broadcasters and composite layout is needed. true: Enable transcoding.
  ...
  /// Deprecated:
  ///  This method is deprecated.
  ///  This method is deprecated. After a successful method call, the SDK triggers rtmpStreamingStateChanged on the local client to report the result of deleting the URL. Before calling this method, make sure that the media push function has been enabled.
  ///  This method takes effect only when you are a host in live interactive streaming.
  ///  Call this method after joining a channel.
  ...
  /// After a successful method call, the SDK triggers channelMediaRelayStateChanged the and channelMediaRelayEvent callbacks, and these callbacks return the state and events of the media stream relay. If the channelMediaRelayStateChanged callback returns Running (2) and None (0), and the channelMediaRelayEvent callback returns SentToDestinationChannel (4), it means that the SDK starts relaying media streams between the source channel and the destination channel.
  ...
  ///  The default settings for each profile: For the communication profile: In a voice call, the default audio route is the earpiece.
  ///  In a video call, the default audio route is the speakerphone. If a user calls the disableVideo , muteLocalVideoStream , or muteAllRemoteVideoStreams method, the default audio route switches back to the earpiece automatically. For the live broadcasting profile: Speakerphone.
  ///  This method applies to Android and iOS only.
  ///  This method needs to be set before , otherwise, it will not take effect.
  ///
  /// Param [defaultToSpeaker] The default audio playback route. true: The audio routing is speakerphone. If the device connects to the earpiece or Bluetooth, the audio cannot be routed to the speakerphone.
  ...
  ///
  /// Param [speakerOn] Whether the audio is routed to the speakerphone or earpiece. true: Route the audio to the speakerphone. If the device connects to the earpiece or Bluetooth, the audio cannot be routed to the speakerphone.
  ...
  ///  You can call this method either before or after joining a channel.
  ///
  /// Param [enabled] Enables in-ear monitoring. true: Enables in-ear monitoring.
  ...
  /// You can call this method to enable or disable the dual-stream mode on the publisher side. Dual streams are a hybrid of a high-quality video stream and a low-quality video stream: High-quality video stream: High bitrate, high resolution.
  ///  Low-quality video stream: Low bitrate, low resolution. After you enable the dual-stream mode, you can call setRemoteVideoStreamType to choose to receive the high-quality video stream or low-quality video stream on the subscriber side. This method only takes effect for the video stream captured by the SDK through the camera. If you use video streams from the custom video source or captured by the SDK through the screen, you need to call or to enable dual-stream mode.
  ///  You can call this method either before or after joining a channel.
  ///
  /// Param [enabled] Whether to enable dual-stream mode. true: Enable dual-stream mode.
  ...
  /// This method tests the quality of the users' network connections. By default, this function is disabled. This method applies to the following scenarios: Before a user joins a channel, call this method to check the uplink network quality.
  ...
  ///  Once this method is enabled, the SDK returns the following callbacks: lastmileQuality : The SDK triggers this callback within two seconds depending on the network conditions. This callback rates the network conditions and is more closely linked to the user experience.
  ///  lastmileProbeResult : The SDK triggers this callback within 30 seconds depending on the network conditions. This callback returns the real-time statistics of the network conditions and is more objective. This method applies to the following scenarios: Before a user joins a channel, call this method to check the uplink network quality.
  ...
  ///  The watermark coordinates are dependent on the settings in the setVideoEncoderConfiguration method: If the orientation mode of the encoding video ( VideoOutputOrientationMode ) is fixed landscape mode or the adaptive landscape mode, the watermark uses the landscape orientation.
  ...
  ///
  /// Param [encryptionMode] Encryption mode. "aes-128-xts": 128-bit AES encryption, XTS mode.
  ...
  ///
  /// Param [enabled] Whether to enable built-in encryption: true: Enable the built-in encryption.
  ...
  ///
  /// Param [filePath] The absolute path (including the filename extensions) of the recording file. For example:
  ///  C:\music\audio.aac
  ///  . Ensure that the directory for the log files exists and is writable.
  ///
  ///
  /// Param [sampleRate] The sample rate (kHz) of the recording file. Supported values are as follows: 16000
  ///  (Default) 32000
  ///  44100
  ///  48000
  ///
  ...
  /// You can call this method either before or after joining a channel.
  ///  This method is for Android and iOS only.
  ///  Once face detection is enabled, the SDK triggers the facePositionChanged callback to report the face information of the local user: The width and height of the local video.
  ...
  ///
  /// Param [enable] Whether to enable face detection: true: Enable face detection.
  ...
  /// Call this method before calling joinChannel , enableVideo , or enableLocalVideo , depending on which method you use to turn on your local camera.
  ///
  /// Param [isOn] Whether to turn on the camera flash: true: Turn on the flash.
  ...
  /// Call this method before calling joinChannel , enableVideo , or enableLocalVideo , depending on which method you use to turn on your local camera.
  ///
  /// Param [enabled] Whether to enable the camera auto-face focus function: true: Enable the camera auto-face focus function.
  ...
  ///
  /// Param [reliable] Whether or not the data stream is reliable: true: The recipients receive the data from the sender within five seconds. If the recipient does not receive the data within five seconds, the SDK triggers the streamMessageError callback and returns an error code.
  ///  false: There is no guarantee that the recipients receive the data stream within five seconds and no error message is reported for any delay or missing data stream.
  ///
  /// Param [ordered] Whether or not the recipients receive the data stream in the sent order: true: The recipients receive the data in the sent order.
  ...
  /// Sends data stream messages to all users in a channel. The SDK has the following restrictions on this method: Up to 30 packets can be sent per second in a channel with each packet having a maximum size of 1 KB.
  ///  Each client can send up to 6 KB of data per second.
  ///  Each user can have up to five data streams simultaneously. A successful method call triggers the streamMessage callback on the remote client, from which the remote user gets the stream message. A failed method call triggers the streamMessageError callback on the remote client. Ensure that you call createDataStreamWithConfig to create a data channel before calling this method.
  ...
  /// This method shares a screen or part of the screen. You need to specify the ID of the screen to be shared in this method. This method applies to macOS and Windows only.
  ///  Call this method after joining a channel.
  ...
  ///
  /// Param [captureParams] Screen sharing configurations. The default video dimension is 1920 x 1080, that is, 2,073,600 pixels. Agora uses the value of this parameter to calculate the charges. See ScreenCaptureParameters for details.
  ///
  ...
  /// Deprecated:
  ///  This method is deprecated as of v3.7.0.Agora strongly recommends using startScreenCaptureByDisplayId if you need to start screen sharing on a device connected to another display. This method shares a screen or part of the screen. You need to specify the area of the screen to be shared. This method applies to the Windows platform only.
  ///  Call this method after joining a channel.
  ///
  ...
  /// Deprecated:
  ///  This method is deprecated as of v2.4.0. See the following methods instead: startScreenCaptureByDisplayId
  ///  startScreenCaptureByWindowId
  ///  This method shares the whole screen, a specified window, or the specified region: Whole screen: Set windowId as 0 and rect as null.
  ...
  /// On Android, during screen sharing, make sure the following: The user has granted screen capture permission to the application; otherwise, the SDK triggers the localVideoStateChanged callback and reports ScreenCapturePermissionDenied(16).
  ...
  ///  To capture system audio during screen sharing, ensure that the Android API level is not earlier than 29 as well; otherwise, the method call fails and returns ScreenCaptureSystemAudioNotSupported(3). On iOS, when the screen sharing extension process starts, ends, or quits unexpectedly, the SDK triggers the localVideoStateChanged callback and reports ExtensionCaptureStarted(13), ExtensionCaptureStoped(14), and ExtensionCaptureDisconnected(15) respectively. Call this method after joining a channel.
  ...
  ///  On Android, note the following: On Android 9 and later, to avoid the application being killed by the system after going to the background, Agora recommends you add the foreground service permission android.permission.FOREGROUND_SERVICE to the /app/Manifests/AndroidManifest.xml file.
  ///  Due to performance limitations, screen sharing is not supported on Android TV.
  ///  Due to system limitations, if you are using Huawei phones, do not adjust the video encoding resolution of the screen sharing stream during the screen sharing, or you could experience crashes. On iOS, note the following: This feature is only available for iOS 11 or later.
  ...
  ///  After you call this method, the SDK triggers the rtmpStreamingStateChanged callback on the local client to report the state of the streaming. Ensure that you enable the Media Push service before using this function.
  ...
  ///
  /// Param [enabled] Sets whether to enable low-light enhancement: true: Enable.
  ...
  ///
  /// Param [enabled] Sets whether to enable video noise reduction: true: Enable.
  ///  false: (Default) Disable.
  ///
  ///
  ...
  ///
  /// Param [enabled] Whether to turn on color enhancement: true: Enable.
  ///  false: (Default) Disable.
  ///
  ///
